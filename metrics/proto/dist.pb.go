...
It is generated from these files:
	github.com/google/cloudprober/metrics/proto/dist.proto
...
func (m *Dist) String() string            { return proto1.CompactTextString(m) }
...
func (*Dist) XXX_OneofFuncs() (func(msg proto1.Message, b *proto1.Buffer) error, func(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error), func(msg proto1.Message) (n int), []interface{}) {
...
func _Dist_OneofMarshaler(msg proto1.Message, b *proto1.Buffer) error {
	m := msg.(*Dist)
	// buckets
...
func _Dist_OneofUnmarshaler(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error) {
	m := msg.(*Dist)
	switch tag {
...
func _Dist_OneofSizer(msg proto1.Message) (n int) {
	m := msg.(*Dist)
	// buckets
	switch x := m.Buckets.(type) {
	case *Dist_ExplicitBuckets:
		n += proto1.SizeVarint(1<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(len(x.ExplicitBuckets)))
		n += len(x.ExplicitBuckets)
	case *Dist_ExponentialBuckets:
		s := proto1.Size(x.ExponentialBuckets)
...
func (m *ExponentialBuckets) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*Dist)(nil), "cloudprober.metrics.Dist")
	proto1.RegisterType((*ExponentialBuckets)(nil), "cloudprober.metrics.ExponentialBuckets")
}

func init() {
	proto1.RegisterFile("github.com/google/cloudprober/metrics/proto/dist.proto", fileDescriptor0)
}
