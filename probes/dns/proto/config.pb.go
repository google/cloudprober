...
func (x QueryType) String() string {
	return proto1.EnumName(QueryType_name, int32(x))
}
func (x *QueryType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(QueryType_value, data, "QueryType")
	if err != nil {
		return err
	}
	*x = QueryType(value)
...
func init() {
	...
	proto1.RegisterEnum("cloudprober.probes.dns.QueryType", QueryType_name, QueryType_value)
}
