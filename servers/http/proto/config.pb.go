...
func (*ServerConf) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_950ed5b19aa07cbd, []int{0}
}
...
func (*ServerConf_PatternDataHandler) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_950ed5b19aa07cbd, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("github.com/google/cloudprober/servers/http/proto/config.proto", fileDescriptor_config_950ed5b19aa07cbd)
}

var fileDescriptor_config_950ed5b19aa07cbd = []byte{
