...
It is generated from these files:
	github.com/google/cloudprober/servers/udp/proto/config.proto
...
func (x ServerConf_Type) String() string {
	return proto1.EnumName(ServerConf_Type_name, int32(x))
}
func (x *ServerConf_Type) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ServerConf_Type_value, data, "ServerConf_Type")
	if err != nil {
		return err
	}
...
func init() {
	proto1.RegisterType((*ServerConf)(nil), "cloudprober.servers.udp.ServerConf")
	proto1.RegisterEnum("cloudprober.servers.udp.ServerConf_Type", ServerConf_Type_name, ServerConf_Type_value)
}

func init() {
	proto1.RegisterFile("github.com/google/cloudprober/servers/udp/proto/config.proto", fileDescriptor0)
}
