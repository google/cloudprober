...
It is generated from these files:
	github.com/google/cloudprober/surfacers/postgres/proto/config.proto
...
func init() {
	proto1.RegisterType((*SurfacerConf)(nil), "cloudprober.surfacer.postgres.SurfacerConf")
}

func init() {
	proto1.RegisterFile("github.com/google/cloudprober/surfacers/postgres/proto/config.proto", fileDescriptor0)
}
