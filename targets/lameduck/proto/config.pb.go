...
It is generated from these files:
	github.com/google/cloudprober/targets/lameduck/proto/config.proto
...
func (m *Options) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*Options)(nil), "cloudprober.targets.lameduck.Options")
}

func init() {
	proto1.RegisterFile("github.com/google/cloudprober/targets/lameduck/proto/config.proto", fileDescriptor0)
}
