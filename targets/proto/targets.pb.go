...
import cloudprober_targets_rds1 "github.com/google/cloudprober/targets/rds/client/proto"
...
type TargetsDef_RdsTargets struct {
	RdsTargets *cloudprober_targets_rds1.ClientConf `protobuf:"bytes,3,opt,name=rds_targets,json=rdsTargets,oneof"`
}
type TargetsDef_RtcTargets struct {
	RtcTargets *cloudprober_targets_rtc.TargetsConf `protobuf:"bytes,4,opt,name=rtc_targets,json=rtcTargets,oneof"`
}
...
func (m *TargetsDef) GetRdsTargets() *cloudprober_targets_rds1.ClientConf {
...
func _TargetsDef_OneofUnmarshaler(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error) {
	...
	case 3: // type.rds_targets
		...
		msg := new(cloudprober_targets_rds1.ClientConf)
		err := b.DecodeMessage(msg)
