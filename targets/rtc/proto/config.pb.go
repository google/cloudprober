...
func (*TargetsConf) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_4754e18fe7d9e13c, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/google/cloudprober/targets/rtc/proto/config.proto", fileDescriptor_config_4754e18fe7d9e13c)
}

var fileDescriptor_config_4754e18fe7d9e13c = []byte{
